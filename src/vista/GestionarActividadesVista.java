...
public class GestionarActividadesVista extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnRegresar1 = new rojeru_san.rsbutton.RSButtonMetro();
        jPanel6 = new javax.swing.JPanel();
        jScrollPane1 = new javax.swing.JScrollPane();
        tblActividades = new rojerusan.RSTableMetro();
        ...
        tblActividades.setColorBackgoundHead(new java.awt.Color(0, 153, 0));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestionarActividadesVista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GestionarActividadesVista().setVisible(true);
            }
        });
    }
    ...
    private rojeru_san.rsbutton.RSButtonMetro btnRegresar1;
    ...
    private rojerusan.RSTableMetro tblActividades;
